...
\toprule
API (\texttt{ffrs-api}) & Node~22 Lambda, TypeScript strict, Zod at every boundary; 24 files, $\approx$900 LOC, 34 tests (in-memory tracker/store twins, no network); 416\,KB bundle \\
